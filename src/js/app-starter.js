        ...
        if (event != null) {
          ...
          switch (event['trigger']) {
            ...
            case CoreFormsEvents.WIZARD_STARTED:
              console.log('CoreForms: wizard started');
              break;
            case CoreFormsEvents.WIZARD_NAVIGATION:
              console.log('CoreForms: wizard navigation');
              break;
            case CoreFormsEvents.WIZARD_PREV_PAGE:
              console.log('CoreForms: wizard previous page');
              break;
            case CoreFormsEvents.WIZARD_NEXT_PAGE:
              console.log('CoreForms: wizard next page');
              break;
